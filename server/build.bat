...
pyinstaller gui.py -n patstrap-server --noconfirm --path=.\patstrap-server-env\lib\python3.11\site-packages --hidden-import zeroconf._utils.ipaddress --hidden-import zeroconf._handlers.answers
